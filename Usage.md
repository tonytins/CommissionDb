...
Example: ``cdb -b "Alberta Mann" -r "https://www.furaffinity.net/view/64746038/" -f 43 -p "alberta@example.com" -d "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum ut pretium enim. Sed a neque."``

```csv
Date,Buyer,Reference,Payment,Description,Fee
...
Example: ``cdb ych -b "Bessie Hettinger" -s 4 -f 25 -p "bessie@example.com" -r "https://www.furaffinity.net/view/64746038/" -y Synthesize -c SEK``
